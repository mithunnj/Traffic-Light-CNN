...
YOLO_CONFIG = CURRENT_DIR + "/yolo-coco/yolov3.cfg"
YOLO_WEIGHTS = CURRENT_DIR + "/yolo-coco/yolov3.weights"
COCO_CLASSES = CURRENT_DIR + "/yolo-coco/coco.names"
...
def backup_YOLO_result():
    ...
    '''
    with open('./yolo_result_mit.json', 'w') as write_file:
